        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button
                  onClick={() => currentQuestion < questions.length - 1 && nextQuestion()}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-6">
              ...
              <h3 className="font-bold text-gray-900 mb-4">Question No. Sheet:</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[80vh] overflow-hidden">
            <div className="p-6 border-b">
              <h2 className="text-2xl font-bold text-gray-900">Comprehensive Paragraph</h2>
            </div>
            <div className="p-6 overflow-y-auto max-h-[60vh]">
              <div className="prose prose-gray max-w-none">
                <p className="text-gray-700 leading-relaxed whitespace-pre-line">
                  {examData?.instruction || 'No comprehensive paragraph available.'}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-bold text-gray-900">{getSubmitStats().total}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-bold text-gray-900">{String(getSubmitStats().answered).padStart(3, '0')}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-bold text-gray-900">{String(getSubmitStats().marked).padStart(3, '0')}</p>
                </div>
              </div>
            </div>
